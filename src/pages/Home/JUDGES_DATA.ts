...
export const DATA_PRIVACY: Item[] = [
  {
    ...
    description:
      'ALex uses advanced encryption standards (AES-256) to protect your data during transit (TLS 1.2+) and at rest. This ensures that your data is secure from unauthorized access, meeting the highest standards of data protection.',
  },
  {
    title: 'Data Integrity',
    description:
      'ALex ensures that your data is not altered or tampered with in any way. We maintain the integrity of your data, providing you with the confidence that the information you provide remains as you intended.',
  },
  {
