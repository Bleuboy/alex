...
export const DATA_PRIVACY: Item[] = [
  {
    ...
    description:
      'ALex uses advanced encryption standards (AES-256) to protect your data during transit (TLS 1.2+) and when stored. This ensures your data is secure from unauthorized access, adhering to the highest standards of data protection.',
  },
  {
    title: 'Data Integrity',
    description:
      'Rest assured, ALex ensures that your data is not altered or tampered with in any way. We maintain the integrity of your data, giving you the confidence that the information you provide remains as you intended.',
  },
  {
    title: 'Data Availability',
    description:
      'ALex is designed to be available when you need it. We use reliable cloud-based solutions to ensure that your data is accessible whenever you need it, without compromising on security.',
  },
  {
    title: 'Data Privacy',
    description:
      'ALex does not store any data. We do not use data provided and generated by ALex to train our own models or improve our service offering. Our cloud-based solution hosts the model on a server located in Germany, ensuring that data remains within the country and is not shared with any third parties. ALex intends to make use of this option.',
  },
];
